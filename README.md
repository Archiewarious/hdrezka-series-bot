...
```
 ...
 ленты разделов — каталог,          │               │
 страницы тайтлов — по событию ─────┘              bot (поиск, подписки)
```

- **Нагрузка на сайт не зависит от числа пользователей**: опрашивается блок
  обновлений на главной, а не подписки. ~45–80 запросов в час при 1 и при 100 000 подписчиков.
