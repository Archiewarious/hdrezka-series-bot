...
STRINGS: dict[str, dict[str, str | tuple]] = {
    ...
    "follow_desc": {
        ...
        "uk": "Повідомлю про нові серії, а коли сезон завершиться — про продовження: новий сезон, фільм або спін-оф.",
        "en": "I'll tell you about new episodes, and when the season ends — about the sequel: a new season, film or spin-off.",
    },
    "follow_desc_franchise": {
        "ru": "Одна кнопка на всё: новые серии этого сезона и всё новое по франшизе — сезоны, фильмы, спин-оффы.",
        "uk": "Одна кнопка на все: нові серії цього сезону і все нове за франшизою — сезони, фільми, спін-офи.",
        "en": "One button for everything: new episodes of this season and everything new in the franchise — seasons, films, spin-offs.",
    },
    "btn_open_franchise": {"ru": "🎞 Франшиза «{name}»", "uk": "🎞 Франшиза «{name}»", "en": "🎞 Franchise “{name}”"},
    "btn_fr_parts_n": {"ru": "🎞 Состав франшизы ({n})", "uk": "🎞 Склад франшизи ({n})", "en": "🎞 Franchise parts ({n})"},
    ...
    "btn_feedback": {"ru": "✉️ Написать автору", "uk": "✉️ Написати автору", "en": "✉️ Contact the author"},
    "cmd_feedback": {"ru": "Написать автору", "uk": "Написати автору", "en": "Contact the author"},
    "fb_choose": {"ru": "✉️ <b>Написать автору</b>\n\nО чём сообщение?",
                  "uk": "✉️ <b>Написати автору</b>\n\nПро що повідомлення?",
                  "en": "✉️ <b>Contact the author</b>\n\nWhat is it about?"},
    "fb_topic_bug": {"ru": "🐞 Ошибка", "uk": "🐞 Помилка", "en": "🐞 Bug"},
    "fb_topic_idea": {"ru": "💡 Идея", "uk": "💡 Ідея", "en": "💡 Idea"},
    "fb_topic_collab": {"ru": "🤝 Сотрудничество", "uk": "🤝 Співпраця", "en": "🤝 Partnership"},
    "fb_topic_other": {"ru": "✉️ Другое", "uk": "✉️ Інше", "en": "✉️ Other"},
    "fb_prompt_bug": {"ru": "Опишите одним сообщением, что случилось. Скриншот можно приложить к этому же сообщению.",
                      "uk": "Опишіть одним повідомленням, що сталося. Скриншот можна додати до цього ж повідомлення.",
                      "en": "Describe what happened in one message. You can attach a screenshot to it."},
    "fb_prompt_idea": {"ru": "Напишите одним сообщением, что добавить или поменять.",
                       "uk": "Напишіть одним повідомленням, що додати чи змінити.",
                       "en": "Tell me in one message what to add or change."},
    "fb_prompt_collab": {"ru": "Напишите одним сообщением, что предлагаете. Если удобнее связаться не в Telegram — оставьте контакт.",
                         "uk": "Напишіть одним повідомленням, що пропонуєте. Якщо зручніше зв'язатися не в Telegram — залиште контакт.",
                         "en": "Describe your proposal in one message. If you prefer a channel other than Telegram, leave a contact."},
    "fb_prompt_other": {"ru": "Напишите одним сообщением — передам автору.",
                        "uk": "Напишіть одним повідомленням — передам автору.",
                        "en": "Write it in one message and I'll pass it to the author."},
    "fb_cancel": {"ru": "Отмена", "uk": "Скасувати", "en": "Cancel"},
    "fb_cancelled": {"ru": "Хорошо, не отправляю.", "uk": "Добре, не надсилаю.", "en": "OK, not sending."},
    "fb_sent": {"ru": "✅ Отправлено автору. Ответ придёт сюда.", "uk": "✅ Надіслано автору. Відповідь прийде сюди.",
                "en": "✅ Sent to the author. The reply will come here."},
    "fb_failed": {"ru": "Не получилось отправить — попробуйте чуть позже.", "uk": "Не вдалося надіслати — спробуйте трохи пізніше.",
                  "en": "Couldn't send it — please try again a bit later."},
    "fb_too_many": {"ru": "Слишком много сообщений автору — попробуйте позже.", "uk": "Забагато повідомлень автору — спробуйте пізніше.",
                    "en": "Too many messages to the author — please try later."},
    "fb_answer_head": {"ru": "✉️ <b>Ответ автора</b>", "uk": "✉️ <b>Відповідь автора</b>", "en": "✉️ <b>Reply from the author</b>"},
    "fb_answer_hint": {"ru": "<i>Чтобы ответить, нажмите «Ответить» на этом сообщении.</i>",
                       "uk": "<i>Щоб відповісти, натисніть «Відповісти» на цьому повідомленні.</i>",
                       "en": "<i>To answer, use “Reply” on this message.</i>"},
    # Для автора — на его языке
    "fb_card": {"ru": "{topic} · <b>обращение №{n}</b>\n👤 {who}\n🌐 {ulang} · подписок: {subs} · с {since}\n\n"
                      "<i>Ответьте на это сообщение — ответ уйдёт человеку от имени бота.</i>",
                "uk": "{topic} · <b>звернення №{n}</b>\n👤 {who}\n🌐 {ulang} · підписок: {subs} · з {since}\n\n"
                      "<i>Дайте відповідь на це повідомлення — її отримає людина від імені бота.</i>",
                "en": "{topic} · <b>request #{n}</b>\n👤 {who}\n🌐 {ulang} · subscriptions: {subs} · since {since}\n\n"
                      "<i>Reply to this message — the person gets it from the bot.</i>"},
    "fb_card_more": {"ru": "↩️ {topic} · <b>обращение №{n}</b>, продолжение\n👤 {who}",
                     "uk": "↩️ {topic} · <b>звернення №{n}</b>, продовження\n👤 {who}",
                     "en": "↩️ {topic} · <b>request #{n}</b>, follow-up\n👤 {who}"},
    "fb_delivered": {"ru": "✅ Доставлено", "uk": "✅ Доставлено", "en": "✅ Delivered"},
    "fb_blocked": {"ru": "❌ Не доставлено: человек заблокировал бота", "uk": "❌ Не доставлено: людина заблокувала бота",
                   "en": "❌ Not delivered: the person blocked the bot"},
    "fb_not_delivered": {"ru": "❌ Не доставлено: {reason}", "uk": "❌ Не доставлено: {reason}", "en": "❌ Not delivered: {reason}"},
    # --- озвучки
    ...
    "my_hint": {"ru": "<i>Нажмите на сериал — там озвучка и отписка.</i>",
                ...
                "en": "<i>Tap a series to change the dub or unsubscribe.</i>"},
    "btn_back_to_my": {"ru": "« Мои подписки", "uk": "« Мої підписки", "en": "« My subscriptions"},
    ...
    "lbl_photos": {"ru": "🖼 Картинки", "uk": "🖼 Картинки", "en": "🖼 Pictures"},
    "lbl_quiet": {"ru": "🌙 Тихие часы", "uk": "🌙 Тихі години", "en": "🌙 Quiet hours"},
    "lbl_delivery": {"ru": "📨 Доставка", "uk": "📨 Доставка", "en": "📨 Delivery"},
    "opt_on": {"ru": "Вкл", "uk": "Увімк", "en": "On"},
    "opt_off": {"ru": "Выкл", "uk": "Вимк", "en": "Off"},
    "opt_now": {"ru": "Сразу", "uk": "Одразу", "en": "Now"},
    "opt_digest_short": {"ru": "Дайджест", "uk": "Дайджест", "en": "Digest"},
