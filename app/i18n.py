...
STRINGS: dict[str, dict[str, str | tuple]] = {
    ...
    "opt_photos_on": {"ru": "🖼 Вкл", "uk": "🖼 Увімк", "en": "🖼 On"},
    "opt_photos_off": {"ru": "🖼 Выкл", "uk": "🖼 Вимк", "en": "🖼 Off"},
    "opt_quiet_on": {"ru": "🌙 {f:02d}:00–{t:02d}:00", "uk": "🌙 {f:02d}:00–{t:02d}:00", "en": "🌙 {f:02d}:00–{t:02d}:00"},
    "opt_quiet_off": {"ru": "🌙 Выкл", "uk": "🌙 Вимк", "en": "🌙 Off"},
    "opt_digest_now": {"ru": "📨 Сразу", "uk": "📨 Одразу", "en": "📨 Immediately"},
    "opt_digest": {"ru": "📨 Дайджест в {h}:00", "uk": "📨 Дайджест о {h}:00", "en": "📨 Digest at {h}:00"},
